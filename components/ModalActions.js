...
import { db } from '../firebase'; // Đảm bảo import đúng
import { doc, deleteDoc } from 'firebase/firestore'; // Import các hàm Firestore

const ModalActions = ({ modalVisible = false, setModalVisible, navigation, id }) => {
  const deleteExpense = async () => {
    try {
      await deleteDoc(doc(db, 'expense', id)); // Sử dụng deleteDoc
